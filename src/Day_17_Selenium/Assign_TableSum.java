...
//5) Print Book names whose Author is Mukesh..
         for(int r=2;r<=rows+1;r++)//Classic for loop for Rows
         {
        	...
        	// System.out.println(Author);
        	 ...
        	 {
        		 String books_name=driver.findElement(By.xpath("//table[@name='BookTable']/tbody/tr["+r+"]/td[1]")).getText();
        		 System.out.println(Author+"  "+books_name);//Learn Java/ Master in Selenium
        	 }
         }
         
//6) Calculate the Sum Price..
         ...
         for(int r=2;r<=(rows+1);r++)
         {
        	 ...
        	 int pvalues = Integer.parseInt(price);  //Converting String to Interger
        	 sum=sum+pvalues;
